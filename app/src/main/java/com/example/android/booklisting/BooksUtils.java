...
public class BooksUtils {
    ...
    public static final String LOG_TAG = BooksUtils.class.getSimpleName();
    ...
    private static List<Books> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < booksArray.length(); i++) {
                ...
                JSONObject currentEarthquake = booksArray.getJSONObject(i);
                ...
                // Extract the value for the key called "pub"
                ...
                // Create a new {@link Earthquake} object with the title, authors, publisher,
                // and url/infoLink from the JSON response.
                Books book = new Books(title, authors, publisher, url);
